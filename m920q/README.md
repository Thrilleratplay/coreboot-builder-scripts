...
`coreboot_lenovo-m920q-chip1.rom.sha256` - sha256 checksum of 16MB Coreboot BIOS
...
Once connected, start a serial terminal emulator such as [minicom](https://salsa.debian.org/minicom-team/minicom) or [tio](https://github.com/tio/tio) before powering on the M920q.